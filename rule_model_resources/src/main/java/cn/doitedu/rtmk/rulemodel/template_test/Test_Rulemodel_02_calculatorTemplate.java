...
public class Test_Rulemodel_02_calculatorTemplate {
    ...
    public static void main(String[] args) throws InstantiationException, IllegalAccessException {
        ...
        Template template = Engine.use().getTemplate("/Users/yuyuyuyu/学习文档/亿级在线实时动态规则运营系统（V2架构）/源码/doe-data-master/rule_model_resources/templates/rule_calculator/rulemodel_02_caculator.enjoy");
