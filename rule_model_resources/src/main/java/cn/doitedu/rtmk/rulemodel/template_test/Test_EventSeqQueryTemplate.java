...
public class Test_EventSeqQueryTemplate {
    ...
    public static void main(String[] args) {
        ...
        Template template = Engine.use().getTemplate("/Users/yuyuyuyu/学习文档/亿级在线实时动态规则运营系统（V2架构）/源码/doe-data-master/rule_model_resources/templates/doirs_sql/action_seq_condition_query.sql.enjoy");
